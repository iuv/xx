...
func K8s(cmd, a1, a2, a3, a4 string) {
	...
	case "l", "log":
		logs(a1, a2, a3)
	case "p", "pod":
		getResource("pod", a1, a2)
	case "d", "deployment":
		getResource("deployment", a1, a2)
	case "i", "ingress":
		getResource("ingress", a1, a2)
	case "s", "service":
		getResource("service", a1, a2)
	case "c", "configmap":
		getResource("configmap", a1, a2)
	case "sec", "secret":
	...
	case "dy", "deploymenty":
		resourceYaml("deployment", a1, a2, a3)
	case "iy", "ingressy":
		resourceYaml("ingress", a1, a2, a3)
	case "sy", "servicey":
		resourceYaml("service", a1, a2, a3)
	case "cy", "configmapy":
		resourceYaml("configmap", a1, a2, a3)
	case "secy", "secrety":
	...
	case "ddel", "deploymentdel":
		resourceDel("deployment", a1, a2)
	case "idel", "ingressdel":
		resourceDel("ingress", a1, a2)
	case "sdel", "servicedel":
		resourceDel("service", a1, a2)
	case "secdel", "secretdel":
	...
	case "de", "deploymente":
		resourceEdit("deployment", a1, a2)
	case "ie", "ingresse":
		resourceEdit("ingress", a1, a2)
	case "se", "servicee":
		resourceEdit("service", a1, a2)
	case "ce", "configmape":
		resourceEdit("configmap", a1, a2)
	case "sece", "secrete":
	...
	case "copy":
		cp(a1, a2, a3, a4)
	default:
		fmt.Println("command not found: k" + cmd)
	}
}
